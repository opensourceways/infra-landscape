    ...
    export default defineComponent({
        ...
        methods: {
            changePageHeight() {
                ...
                console.log(parseInt(window.getComputedStyle(document.getElementsByTagName('main')[0]).height));
                console.log(document.documentElement.clientHeight);
                console.log(parseInt(window.getComputedStyle(document.getElementsByClassName('footer-wrapper')[0]).height));
